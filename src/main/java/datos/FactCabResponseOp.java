 ...
 */
public class FactCabResponseOp implements Payload{
...
//    private CteTipoResponse cteTipo;
    ...
    public FactCabResponseOp(FactCab f) {
        ...
        this.importePendiente = BigDecimal.ZERO;
    ...
    public FactCabResponseOp(Integer idFactCab, String comprobante,long numero, Date fechaEmision, Date fechaVence, Integer idPadron, String nombre, String cuit, BigDecimal cotDolar, String moneda, Integer idmoneda, String imputada, String modulo, String vendedor, Integer idCteTipo, BigDecimal importeNeto, BigDecimal importeTotal, String tipoOperacion, String autorizada, String permiteBorrado, Integer kilosCanje, Boolean pesificado, Boolean dolarizadoAlVto, BigDecimal interesMensualCompra, Boolean canjeInsumos, String tipoCambio, BigDecimal importePendiente, Integer idFormaPago) {
