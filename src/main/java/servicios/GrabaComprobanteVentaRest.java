 ...
 */
@Stateless
@Path("grabaComprobanteVenta")
public class GrabaComprobanteVentaRest {
...
//            String dir = "";
    ...
    public Response persistirObjetos(FactCab factCab,
        ...
        try {
            ...
            // no iria nada solo graba en factCab y en otro servicio esperamos que 
            // fact electronica se autorize bien y sigo el proceso depasajes a las otras tablas
            if (  factCab.getIdCteTipo().getIdSisComprobante().getIdSisComprobantes().equals(28)
               ...
               // reemplazar por la clase: this.grabarFactComprasSybase(factCab, factDetalle, factFormaPago, factPie, user);
                ...
                if (factCab.getIdCteTipo().getCursoLegal()) {
                   /* GrabaVentasMaster ventasMaster = new GrabaVentasMaster();
                     Response respGrabarMaster = ventasMaster.grabarMaster(factCab, factDetalle, factFormaPago, factPie, user);
                    if (respGrabarMaster.getStatusInfo().equals(Response.Status.CREATED) || respGrabarMaster.getStatusInfo().equals(Response.Status.BAD_REQUEST)) {
                        ...
                        if (respGrabaMasterSybase == true) {
                                GrabaFacVentaSybase fcSybase = new GrabaFacCompraSybase();
                                fcSybase.grabarFactVemtasSybase(factCab, factDetalle, factFormaPago, factPie, user);
                        }
                    }*/
                }
